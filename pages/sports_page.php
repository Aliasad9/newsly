    ...
    <main class="container">
      ...
      <div class="row mb-2">
        <div class="section-heading d-flex justify-content-between align-items-center py-4">
          <h3 class="font-italic">Latest Sports News</h3>
        </div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card mb-4">
            <img src="../assets/sports-image-4.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
              <strong class="d-inline-block mb-2 text-primary">Sports</strong>
              <h5 class="card-title">Card title</h5>
              <div class="mb-1 text-muted">Nov 11</div>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="card mb-4">
            <img src="../assets/sports-image-5.jpg" class="card-img-top" alt="..." />
            <div class="card-body">
              <strong class="d-inline-block mb-2 text-primary">Sports</strong>
              <h5 class="card-title">Card title</h5>
              <div class="mb-1 text-muted">Nov 11</div>
